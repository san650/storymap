...
Provide an end-to-end test suite that drives the Storymap PWA in a real browser,
covering the application's user-facing features and geometry-derived behavior, with
isolated scenarios seeded from a fresh app and declarative feature files.
